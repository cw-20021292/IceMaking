...
#define STX_FRONT_COMM                         0x02
#define ETX_FRONT_COMM                         0x03

#define REQUEST_COMMAND_FRONT_COMM             0x07
#define RESPONSE_COMMAND_FRONT_COMM            0x09

#define MAIN_TO_FRONT_DATA_TOTAL_LENGTH        34
#define FRONT_TO_MAIN_DATA_TOTAL_LENGTH        10

#define MAIN_CRC_CALC_RANGE                    31
#define FRONT_CRC_CALC_RANGE                   7

#define FRONT_RX_BUFFER_SIZE                   33
#define FRONT_TX_BUFFER_SIZE                   15

#define MAIN_COMMAND_ROCATION                  1
#define MAIN_LENGTH_ROCATION                   2

#define MAIN_CRC_HIGH_ROCATION                 31
#define MAIN_CRC_LOW_ROCATION                  32

#define TX_RETRY_COUNT                         50
...
extern U16 gu16_Key_Input_Final;
extern U8 gu8_ext_led_dimming_percent;
extern U8 gu8_selected_led_dimming;
extern U8 gu8_unselected_led_dimming;

extern U8 gu8_hot_led_dimming;
extern U8 gu8_hot_lock_dimming;
extern U8 gu8_room_dimming;
extern U8 gu8_cold_dimming;
extern U8 gu8_cup_dimming;
extern U8 gu8_extract_dimming;
extern U8 gu8_welcome_dimming;
extern U8 gu8_etc;

extern bit bit_uv_ice_extraction_out;

extern U16 gu16_AD_Result_UV_Ice_Extraction_Current;
extern U8 gu8_ota_start;
