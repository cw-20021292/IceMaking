...
/*..sean [25-02-12] enum Í∞?Í∞Ä?∏Ïò§Í∏??ÑÌï¥??function list ?§Îçî?åÏùº Ï∂îÍ? ..*/
...
U8 u8OutHot_Temp_AVG;             // ?âÍ∑† Ï∂úÏàò?®ÎèÑÍ∞?(App??


U16 gu16_silver_timer_sec;
U16 gu16_silver_timer_min;
bit F_Siver_Care_Alarm;             // ?§Î≤ÑÏºÄ???úÎπÑ??ÏßÑÏûÖ ?åÎûòÍ∑?App??
...
void send_wifi_data(void)
{
    ...
    /*..hui [21-3-15?§ÌõÑ 7:08:48] Î¨?Ï∂îÏ∂ú Ï¢ÖÎ£ü ??.*/
    check_water_out_state();

    /*..hui [21-8-3?§ÌõÑ 4:34:47] TDSÍ∞??ÖÎéÉ?êÏúº???úÎ≤Ñ ?ÑÏÜ°..*/
    ...
    /*..hui [21-9-6?§Ï†Ñ 10:36:57] Í≥†Ïû•ÏßÑÎã® ?ÅÌÉú..*/
    check_self_manual_state();

    /*..hui [21-8-3?§ÌõÑ 7:26:37] 1. TDS Ï∏°Ï†ï ?ÑÎ£å?àÏùÑ??.*/
    /*..hui [21-8-3?§ÌõÑ 7:26:52] 2. Î≤ÑÌäº - ?ÑÏ≤¥?†Í∏à ?§Ï†ï..*/
    /*..hui [21-8-3?§ÌõÑ 7:26:56] 3. Î≤ÑÌäº - ?®Ïàò?†Í∏à ?§Ï†ï..*/
    /*..hui [21-8-3?§ÌõÑ 7:27:06] 4. Î≤ÑÌäº - ?âÏàò ON/OFF ?§Ï†ï..*/
    /*..hui [21-8-3?§ÌõÑ 7:27:14] 5. LCD - Í∏∞Î≥∏?©Îüâ ?§Ï†ï..*/
    /*..hui [21-8-3?§ÌõÑ 7:27:20] 6. LCD - ?âÏàò?®ÎèÑ ?§Ï†ï..*/
    /*..hui [21-8-3?§ÌõÑ 7:27:26] 7. LCD - ?¨Ïö¥???§Ï†ï..*/
    /*..hui [21-8-3?§ÌõÑ 7:27:34] 8. LCD - ?úÎπÑ?§Î™®???§Ï†ï..*/
    /*..hui [21-8-3?§ÌõÑ 7:27:41] 9. LCD - ?åÏö∞???ÄÍ∏∞ÏãúÍ∞??§Ï†ï..*/
    /*..hui [21-8-3?§ÌõÑ 7:27:50] 10. LCD - ?ÑÏ≤¥?†Í∏à ?§Ï†ï - CPÎß?.*/
    /*..hui [21-8-3?§ÌõÑ 7:28:05] 11. UV ?¥Í∑† ??.*/
    /*..hui [21-8-3?§ÌõÑ 7:28:08] 12. ?êÎèôÎ∞∞Ïàò ??.*/
    ...
    {
        /*..hui [23-6-28?§Ï†Ñ 11:01:09] ?úÌíà?êÏÑú Í∞úÎ≥Ñ ?úÏñ¥Î°??§Ï†ï Î≥ÄÍ≤ΩÌï†??.*/
...
void check_water_out_state(void)
{
    /*..hui [21-3-5?§ÌõÑ 2:01:13] Î¨?Ï∂îÏ∂ú Ï¢ÖÎ£å????.*/
    if( F_WaterOut == SET )
    {
        if( F_Wifi_Water_Out == CLEAR )
        {
            ...
            /*..hui [21-9-8?§Ï†Ñ 10:52:32] ?êÍ?ÏßÑÎã® Í∏àÏ?Î•??¨Í∏∞??Î≥¥ÎÇ¥?îÍ±∏Î°?.*/
    ...
    else
    {
        if( F_Wifi_Water_Out == SET )
        {
            ...
            if( gu8_water_send_timer >= 5 )
            {
                ...
                /*..hui [21-11-2?§ÌõÑ 7:42:57] ?âÏàò?±ÌÅ¨ Ï±ÑÏö∞Í∏∞ÍπåÏßÄ ?ùÎÇòÍ≥??®Ïàò ?úÎ†à???ÑÏóê Î¨?Ï∂îÏ∂ú Í∞Ä?•Ìïú ÏßÄ?êÏóê..*/
                /*..hui [21-11-2?§ÌõÑ 7:43:20] Î¨?Ï∂îÏ∂ú???ùÎÇ¨?¥ÎèÑ ?ïÎ?ÏßÑÎã®?Ä Í∏àÏ??ÅÌÉú ?†Ï??¥Ïïº??.*/
				//?ÑÎ°ú?†ÏΩú ÎØ∏Ï†Å?©ÏúºÎ°?Î≥ÄÍ≤??àÏ†ï
                ...
                /*..hui [24-1-9?§ÌõÑ 1:29:37] 1010Î≥¥ÎÇ¥Í≥?1014ÍπåÏ? Î≥¥ÎÇ¥Í≥??úÌõÑ Ï¥àÍ∏∞?îÌïòÍ∏∞ÏúÑ??Ïπ¥Ïö¥??.*/
...
U8 check_error_state(void)
{
    ...
    /*..hui [21-3-12?§ÌõÑ 3:12:16] ?®Ïàò ?àÌÑ∞ ?ºÏÑú ?êÎü¨..*/
...
void make_wifi_app_data(void)
{
    /*..hui [23-9-25?§ÌõÑ 3:35:50] 7Ï¥àÌõÑ Î≥µÍ??úÏóê??Î≥¥ÎÇ¥Î©¥Ïïà??.*/
    /*..hui [23-9-25?§ÌõÑ 3:36:12] ??Ï°∞Ïûë?ºÎ°ú Î≥ÄÍ≤ΩÏãú?êÎßå A1014Îß?Î≥¥ÎÇ¥?ºÌï®..*/
    /*wifi_water_select();*/
    ...
    /*..hui [23-8-29?§ÌõÑ 4:56:28] ?ºÏùå ?úÏä§??Í¥Ä???∞Ïù¥?Ä..*/
    wifi_ice_data_all();

    /*..hui [23-8-30?§Ï†Ñ 9:48:04] ?åÎü¨??Í¥Ä???∞Ïù¥?Ä..*/
    //wifi_flushing();

    /*..hui [23-8-31?§ÌõÑ 2:48:21] ?úÌíà ÎØ∏ÏÇ¨???úÍ∞Ñ..*/
    wifi_no_use_time();

    /*..hui [23-8-31?§ÌõÑ 2:48:27] ?§Îßà???àÏ†Ñ ?ÅÌÉú\..*/
    wifi_smart_save_state();

    /*..hui [23-12-6?§Ï†Ñ 10:39:35] Ï∑®Ïπ®Î™®Îìú ?ÅÌÉú..*/
    wifi_sleep_mode();
}
...
{
    #if 0
    /*..hui [23-8-2?§ÌõÑ 5:12:16] ?âÏò®??Î≥ÄÍ≤ΩÏÉÅ??Ï∂îÍ?..*/
    /*..hui [23-8-2?§ÌõÑ 5:12:21] ?Ä???¥Í±¥ 1010Îß?Î≥¥ÎÉÑ..*/
...
void avg_mixing_water_temp(void)
{
    ...
    /*..hui [23-6-26?§ÌõÑ 7:18:28] ÎØ∏Ïò®??Ï∂îÏ∂ú..*/
...
{
    #if 0
    /*..hui [21-3-5?§Ï†Ñ 9:58:17] Ïª§Î≤Ñ ?´Ìûò..*/
    ...
    /*..hui [21-3-12?§ÌõÑ 4:50:57] ?¥Î†∏?ÑÎïåÎß?Ïπ¥Ïö¥??.*/
...
void power_check(void)
{
    /*..hui [21-8-3ø¿»ƒ 3:15:27] ºæº≠ µ•¿Ã≈∏¥¬ 1∫–ø° «—π¯æø ∫∏≥ø - «ˆπŒ¿Ã∞°..*/
    /*..hui [23-6-28ø¿¿¸ 10:57:18] 5∫–ø° «—π¯æø ∫∏≥ª¥¬∞…∑Œ ∫Ø∞Ê.. º’∞˙¿Â..*/
	...
	//western AIS
    /*..hui [21-3-5ø¿¿¸ 11:58:23] ø¬ºˆ»˜≈Õ 2920/3600 = 0.81 = 0.80 = 0.65..*/
    /*..hui [21-3-5ø¿¿¸ 11:58:55] COMP 100/3600 = 0.027 = 0.03..*/
    /*..hui [21-3-5ø¿¿¸ 11:59:18] ≈ª∫˘»˜≈Õ 150/3600 = 0.04..*/
    /*..hui [23-6-26ø¿»ƒ 7:45:15] ø¬ºˆ»˜≈Õ 500/3600 = 0.138 = 0.138..*/
    /*..hui [23-7-25ø¿»ƒ 5:15:15] ø¬ºˆ»˜≈Õ 430/3600 = 0.119..*/
	
	//Ro Lite

    /*..sean [21-3-5ø¿¿¸ 11:58:23] ø¬ºˆ»˜≈Õ 2920/3600 = 0.81 = 0.80 = 0.65..*/
    /*..sean [21-3-5ø¿¿¸ 11:58:55] COMP 100/3600 = 0.027 = 0.03..*/
    /*..sean [21-3-5ø¿¿¸ 11:59:18] ≈ª∫˘»˜≈Õ 150/3600 = 0.04..*/
    /*..sean [23-6-26ø¿»ƒ 7:45:15] ø¬ºˆ»˜≈Õ 250/3600 = 0.069 = 0.069..*/
    /*..sean [23-7-25ø¿»ƒ 5:15:15] ø¬ºˆ»˜≈Õ 430/3600 = 0.06..*/
    if( pHEATER_HOT == SET )
    {
        gu16_hot_heater_watt += HOT_HEATER_WATT_FULL;

        /*..hui [21-10-15?§ÌõÑ 5:12:31] ÏµúÎ? 50W ?úÌïú..*/
    ...
    if( F_Comp_Output == SET )
    {
        ...
        {
            /*..hui [23-11-9?§Ï†Ñ 9:33:43] ?∏Í∏∞ 30??Ï¥àÍ≥º. ?âÍ∞Å 90W == 90/3600 = 0.025..*/
            gu16_comp_watt += COMP_COLD_90_WATT;
        }
        else
        {
            /*..hui [23-11-9?§Ï†Ñ 9:34:20] ?∏Í∏∞ 30??Ï¥àÍ≥º. ?ºÏùå 80W == 80/3600 == 0.022..*/
...
void water_quantity(void)
{
    /*..hui [21-3-5?§ÌõÑ 12:36:51] Í≥ÑÏÇ∞?Ä acc_water ?¨Ïö©..*/
...
void send_wifi_system_function(void)
{
    /*..hui [21-3-5?§ÌõÑ 2:03:48] WIFI ?§Ï†ï Î≥ÄÍ≤??∞Ïù¥?Ä ?°Ïã†..*/
...
void send_wifi_each_data_control( U8 mu8_data )
{
    ...
    /*..hui [23-7-21?§ÌõÑ 6:55:28] Í∞úÎ≥Ñ ?§Ï†ï Î≥ÄÍ≤ΩÏãú?êÎäî..*/
    /*..hui [23-7-21?§ÌõÑ 6:56:10] Í∞úÎ≥Ñ ?§Ï†ï Î≥ÄÍ≤ΩÏãú?êÎäî ?ÑÏ≤¥ ?∞Ïù¥?∞ÎèÑ ?®Íºê ?ÑÏÜ°.. ?êÍ≥º??.*/
    send_wifi_system_function();

    /*..hui [24-1-9?§ÌõÑ 1:29:37] 1010Î≥¥ÎÇ¥Í≥?1014ÍπåÏ? Î≥¥ÎÇ¥Í≥??úÌõÑ Ï¥àÍ∏∞?îÌïòÍ∏∞ÏúÑ??Ïπ¥Ïö¥??Ï¥àÍ∏∞??.*/
	//header file ?åÏñ¥?????ÜÏñ¥???ÄÏ≤¥Î°ú ?òÏ†ï
...
{
    #if 0
    /*..hui [21-9-9?§Ï†Ñ 10:23:49] ?ºÏãú ?ïÏ?Ï§ëÏóê??0?ºÎ°ú Î≥¥ÎÇ¥Í≥??¨Ïãú?ëÌï†???§Ïãú~..*/
...
void wifi_ice_out_time(void)
{
    /*..hui [23-8-2?§ÌõÑ 4:48:04] ?§ÌÅ¨Î•??ÑÎäî ?úÍ∞ÑÎß?Í≥ÑÏÇ∞..*/
...
void wifi_water_level_state(void)
{
    /*..hui [23-6-23?§ÌõÑ 4:45:23] ?âÏàò ?Ä?òÏúÑ/ÎßåÏàò?ÑÎßå..*/
    /*..hui [23-6-23?§ÌõÑ 4:45:35] ?úÎ†à?∏ÌÉ±???Ä?òÏúÑ/ÎßåÏàò?ÑÎäî water_level ?¥Ï™Ω?êÏÑú Ï≤òÎ¶¨..*/
...
void wifi_ice_data_all(void)
{
    /*..hui [23-8-29?§ÌõÑ 4:55:49] ?úÎπô ?ÑÎ£å?úÍ∞Ñ / ?àÎπô ?ÑÎ£å?úÍ∞Ñ / ?∏Î†à???ÖÏàò ?úÍ∞Ñ / ?∏Î†à???ÖÏàò ?†Îüâ ?ÑÏÜ°..*/
    /*..hui [23-8-29?§ÌõÑ 4:55:54] ?úÎπô ?ùÎÇòÍ≥??úÎ∞©??.*/
...
void check_self_manual_state(void)
{
    ...
    /*..hui [21-9-8?§Ï†Ñ 10:54:00] ?êÍ?ÏßÑÎã® Í∏àÏ? ?ÅÌÉú?∏Í≤Ω??Î¶¨ÌÑ¥..*/
    ...
    //if(1)
    {
        switch( gu8_wifi_self_test_state )
        {
            case WIFI_SELF_TEST_NO_OPERATION:
                ...
                gu8_wifi_self_test_progress = WIFI_SELF_TEST_0_PERCENT;
                /*..hui [21-9-8?§Ï†Ñ 10:23:33] ?úÏûë?òÎ©¥ ?êÎèô?ºÎ°ú ?Ä?¥Ìåå?¥Ï™Ω?êÏÑú Î≥¥ÎÉÑ..*/
                /*send_wifi_system_function();*/
            ...
            case WIFI_SELF_TEST_FINISH:
                ...
                {
                    /*..hui [21-9-7?§ÌõÑ 4:26:34] ÏµúÏ¢Ö Í≤∞Í≥º ?∞Ïù¥?Ä ?ÑÏÜ°..*/
    ...
    {
        /*..hui [21-9-7?§ÌõÑ 4:20:42] ?ùÎÇòÍ≥?0?Ä ?àÎ≥¥?¥Ï§ò????.*/
        gu8_wifi_self_test_timer = 0;
        gu8_wifi_self_test_state = WIFI_SELF_TEST_NO_OPERATION;
        gu8_wifi_self_test_progress = WIFI_SELF_TEST_0_PERCENT;


        /*..hui [21-9-9?§ÌõÑ 4:11:13] ÏµúÏ¢Ö Í≤∞Í≥º?∞Ïù¥?∞Î? ?¨Í∏∞??Î≥¥ÎÇ¥?îÍ±∏Î°?...*/
        /*..hui [21-9-9?§ÌõÑ 4:11:29] ÏµúÏ¢Ö Í≤∞Í≥º?∞Ïù¥??Î≥¥ÎÇ¥Î©?wifi Ï™ΩÏóê???ÅÌÉú?µÎ≥¥ ?êÎèô?ºÎ°ú ?òÎäî Í≤?Í∞ôÏùå.....*/
...
void check_prohibit_state(void)
{
    /*..hui [23-12-22ÔøΩÔøΩÔøΩÔøΩ 10:28:58] ÔøΩ√∑ÔøΩÔøΩÔøΩ ÔøΩÔøΩÔøΩœ∂ÔøΩ ÔøΩÔøΩÔøΩÔøΩ..*/
    /*..hui [24-3-25ÔøΩÔøΩÔøΩÔøΩ 4:02:20] ÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔø?ÔøΩÔøΩÔøΩÔøΩÔøΩﬂøÔøΩÔøΩÔøΩ ÔøΩÔøΩÔøΩÔøΩ..*/
    if( F_Ice == CLEAR )
    {
