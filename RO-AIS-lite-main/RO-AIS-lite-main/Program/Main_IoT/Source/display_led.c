...
void funcition_led_output(void)
{
    ...
    else
    {
        ...
        /*..hui [24-4-24���� 6:55:05] ���� OFF�϶� ������ư ������ LED ���� �߰�..*/
    ...
    else
    {
        ...
        else
        {
            ...
            /*..hui [23-2-24���� 10:34:45] �߰���忡���� �帮��..*/
            /*..hui [23-2-24���� 10:35:08] AIS3.5�� �¼� �����־ �帮�� �������� �߰�����....*/
			/*.. sean [25-01-02] ������� ��� ��ħ��� �߰�..*/
		    //if( bit_illumi_State == SET )
			    if(bit_sleep_mode_start == SET)
            {
...
void ice_first_icon_output(void)
{
	...
	/*sean [25-03-21] ���� ����� �������� ������ ǥ�þ��� */
    #if 1
    /*..hui [23-5-17���� 1:16:14] ���� ������������ ice first ������ ����.. ���������� �ҵ�.. DR ����..*/
    if( F_IceOn == SET )
    {
...
void hot_temp_led_out(void)
{
    ...
    /* 이전 3회 제빙이력 중 시간완료(1번)인 경우 Hot Temp LED 표시 */
    Bit0_Front_Led_Hot_Temp_1 = (Get_IceMakeHistory(0) == ICE_MAKE_METHOD_TABLE) ? SET : CLEAR;
    Bit1_Front_Led_Hot_Temp_2 = (Get_IceMakeHistory(1) == ICE_MAKE_METHOD_TABLE) ? SET : CLEAR;
    Bit2_Front_Led_Hot_Temp_3 = (Get_IceMakeHistory(2) == ICE_MAKE_METHOD_TABLE) ? SET : CLEAR;
}
...
void cold_temp_led_out(void)
{
    ...
    /* 이전 3회 제빙이력 중 ADC완료(2번)인 경우 Cold Temp LED 표시 */
    Bit3_Front_Led_Cold_Temp_1 = (Get_IceMakeHistory(0) == ICE_MAKE_METHOD_ADC) ? SET : CLEAR;
    Bit4_Front_Led_Cold_Temp_2 = (Get_IceMakeHistory(1) == ICE_MAKE_METHOD_ADC) ? SET : CLEAR;
    Bit5_Front_Led_Cold_Temp_3 = (Get_IceMakeHistory(2) == ICE_MAKE_METHOD_ADC) ? SET : CLEAR;
}
...
void cup_level_led_out(void)
{
    if( bit_my_cup_setting_start == SET )
    {
        ...
        /*..hui [23-3-3���� 4:51:56] �����߿��� ������ ����, �����ư �����.. �������..*/
        /*..hui [23-3-3���� 4:52:06] �� �� �����Ÿ��� �̻���..*/
...
void extract_led_out(void)
{
    if( bit_setting_mode_start == SET )
    {
        ...
        if( bit_my_cup_setting_start == SET || Bit3_My_Cup_Set_Display == SET )
        {
            ...
            /*..hui [23-3-22���� 5:21:51] ���� �Ϸ�ǰ� End ǥ���ϴ� ������ �����־�� ��..*/
...
void percent_ml_led_out(void)
{
	...
	/*.. sean [25-01-06] wifi paring �ÿ��� % ǥ���ϵ��� ���� ..*/
    ...
    {
        /*..hui [23-3-23���� 4:41:21] FND�� LED ��ũ�� ���ؼ� �������� �̵�..*/
...
void setting_led_out(void)
{
    ...
    if( bit_setting_mode_start == SET )
    {
        /*..hui [23-3-22���� 5:35:54] ������ ����.. �� �����ϰ� End ���������� �Ʒ��� Mycup LED�� �ѳ��´�..*/
        if( bit_my_cup_setting_start == SET
