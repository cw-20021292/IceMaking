...
* Description  :
***********************************************************************************************************************/
#ifndef _DISPLAY_LED_SLEEP_H_
#define _DISPLAY_LED_SLEEP_H_
...
extern void set_icon_duty( U8 mu8_number, U8 mu8_on_off );
//extern void all_lock_icon_output(void);
extern void funcition_led_output(void);
extern void temp_led_out(void);
extern U8 all_lock_flick_timer(U8 flick_time, U8 interval);
extern void ice_full_led_output(void);
