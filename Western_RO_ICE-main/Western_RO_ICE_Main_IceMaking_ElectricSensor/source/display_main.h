...
extern void fnd_left_water_out(void);
extern void fnd_left_ice_out(void);
extern void led_setting(void);
...
extern void fnd_right_setting(void);
extern void fnd_right_all_lock(void);
extern void fnd_right_water_out(void);
extern void fnd_right_ice_out(void);
extern void led_button_set(void);
extern void fnd_left_button_set(void);
extern void fnd_right_button_set(void);
extern void fnd_left_steam_clean_state(void);
extern void fnd_right_steam_clean_state(void);
extern void led_steam_clean_state(void);
extern void breath_control(void);
extern void led_uv_state(void);
extern void fnd_left_uv(void);
extern void fnd_right_uv(void);
...
extern void fnd_left_filter_open_state(void);
extern void fnd_right_filter_open_state(void);
extern void fnd_left_filter_alarm_state(void);
extern void fnd_right_filter_alarm_state(void);
extern void led_filter_alarm_state(void);
extern void led_time_setting_state(void);
extern void fnd_left_time_setting_state(void);
extern void fnd_right_time_setting_state(void);
extern void fnd_left_altitude_setting(void);
extern void fnd_right_altitude_setting(void);
extern void led_altitude_setting(void);

extern void fnd_left_sleep(void);
extern void fnd_right_sleep(void);
extern void led_sleep(void);
extern void fnd_left_memento(void);
extern void fnd_right_memento(void);
extern void led_memento_state(void);
extern void led_sound_setting(void);
extern void fnd_right_sound_setting(void);
extern void fnd_left_sound_setting(void);
extern void fnd_left_wifi_pairing(void);
extern void fnd_right_wifi_pairing(void);
extern void led_wifi_pairing(void);
extern void led_ct_filter_type_state(void);
extern void fnd_right_ct_filter_type(void);
extern void fnd_left_ct_filter_type(void);


extern void fnd_left_self_test_state(void);
extern void fnd_right_self_test_state(void);
extern void led_self_test_state(void);
extern void play_voice_replace_filter( void );
extern void led_acid(void);
extern void fnd_left_acid(void);
extern void fnd_right_acid(void);
...
extern U16 gu16_extract_display_timer;
