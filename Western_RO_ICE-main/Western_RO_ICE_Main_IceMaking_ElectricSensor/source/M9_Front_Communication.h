...
// Front PBA Type Á¤º¸
#define PROTOCOL_FRONT_PBA_CHP                      0x20    // CHP ¸ðµ¨
#define PROTOCOL_FRONT_PBA_CP                       0x21    // CP ¸ðµ¨
#define PROTOCOL_FRONT_PBA_HP                       0x22    // HP ¸ðµ¨
#define PROTOCOL_FRONT_PBA_CHPI                     0x23    // CHPI ¸ðµ¨
#define PROTOCOL_FRONT_PBA_CPI                      0x24    // CPI ¸ðµ¨


#define MAIN_TO_FRONT_DATA_TOTAL_LENGTH        69
#define FRONT_TO_MAIN_DATA_TOTAL_LENGTH        11


#define MAIN_CRC_CALC_RANGE                    66
#define FRONT_CRC_CALC_RANGE                   8

#define FRONT_RX_BUFFER_SIZE                   15
#define FRONT_TX_BUFFER_SIZE                   75

#define DEVICE_ID_ROCATION                     1

#define FRONT_CRC_HIGH_ROCATION                8
#define FRONT_CRC_LOW_ROCATION                 9
