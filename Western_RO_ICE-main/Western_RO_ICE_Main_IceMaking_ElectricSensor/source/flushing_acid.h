...
* Description  :
***********************************************************************************************************************/
#ifndef _FLUSHING_ACID_H_
#define _FLUSHING_ACID_H_

//
extern void init_tank_flushing(void);
extern void play_melody_setting_on_198( void );
extern void tank_flushing_pump_output(void);
extern void play_melody_warning_197( void );
extern void reset_time_neo_filter(void);
extern void reset_time_ro_filter(void);
extern void reset_time_ino_filter(void);
extern void neo_ino_filter_alarm(void);
extern void neo_ro_ino_all_filter_alarm(void);
extern void send_wifi_system_function(void);
extern void wifi_neo_ro_ino_filter_alarm_stop(void);
extern void change_filter_type(void);
...
/*#define ACID_WATER_FULL_MAX_TIME    6000*/
#define ACID_WATER_FULL_MAX_TIME    12000

#define ACID_CLEAN_FULL_MAX_TIME    72000



#define ACID_CLEANING_WAIT_TIME     36000
#define DRAIN_CLEANING_TIME         3000
