...
* Description  :
***********************************************************************************************************************/
#ifndef _DISPLAY_LED_ACID_H_
#define _DISPLAY_LED_ACID_H_
...
extern void steam_clean_led_out(void);
extern void min_left_text_output(void);
extern void percent_oC_oF_icon_output(void);
extern void preparing_text_output(void);
extern void wifi_icon_output(void);
extern void filter_flushing_text_output(void);
extern void replace_filter_text_output(void);
extern void replace_filter_1_3_num_led_output(void);
...
extern U8 gu8_acid_display_step;
