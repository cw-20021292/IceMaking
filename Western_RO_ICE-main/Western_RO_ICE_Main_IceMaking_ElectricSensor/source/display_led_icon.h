...
//
//
extern void breath_on_off_select( U8 mu8_number, U8 mu8_on_off );
extern void set_duty_percent( U8 mu8_number, U8 mu8_percent );
extern void filter_flushing_text_output(void);
extern U8 low_water_flickering_timer(U8 flick_time, U8 interval);
...
extern bit bit_hot_current_temp_on;
