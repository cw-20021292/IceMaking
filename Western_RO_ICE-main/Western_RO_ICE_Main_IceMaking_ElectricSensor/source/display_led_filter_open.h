...
* Description  :
***********************************************************************************************************************/
#ifndef _DISPLAY_LED_FILTER_OPEN_H_
#define _DISPLAY_LED_FILTER_OPEN_H_

//

extern void extract_led_out(void);
//extern void water_usage_text_output(void);
extern void eco_icon_output(void);
//extern void gal_text_output(void);
extern void replace_filter_text_output(void);
extern void wifi_icon_output(void);
extern void days_left_text_output(void);
