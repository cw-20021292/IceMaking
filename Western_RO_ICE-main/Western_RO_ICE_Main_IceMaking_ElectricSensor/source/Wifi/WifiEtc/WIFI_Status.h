...
typedef enum
{
    ...
    STATUS_AP_BLE_CON,      // (0(Clear): πÃø¨∞·, 1(SET) : ø¨∞· ¡ﬂ  (BLE STATUS : 3), 2(Done) : ø¨∞· ¡ﬂ 30∫–∞Ê∞˙ Ω√
    STATUS_AP_BLE_ALWAYS,   // (0(Clear): BLE OFF, 1(SET): BLE ªÛΩ√ ONªÛ≈¬, 2(Done): BLE OFF Ω√ ¿Á»∞º∫»≠ ¡ˆΩ√ ¡ﬂ)
    STATUS_AP_BLE_STATUS2_RESPONSE,   // (0(Clear): √ ±‚»≠, 1(SET): ¿¿¥‰ ¿÷¿Ω
