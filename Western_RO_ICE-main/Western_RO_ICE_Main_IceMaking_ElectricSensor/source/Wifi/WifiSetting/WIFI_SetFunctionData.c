...
{   /*  ID                                      Tx Function     Rx Function     */
    ...
    {   WIFI_FUNC_0004_SAVE_SEL,                EvtWifiTxFunc,  EvtWifiRxFunc   }, // 0 / 1
    {   WIFI_FUNC_0005_LOCK_SEL,                EvtWifiTxFunc,  EvtWifiRxFunc   }, // 0 / 1
    {   WIFI_FUNC_0006_MUTE_SEL,                EvtWifiTxFunc,  EvtWifiRxFunc   }, // 0 / 1
    // {   WIFI_FUNC_0007_STERILIZE_SEL,           NULL,           NULL            }, // 0 / 1
    // {   WIFI_FUNC_0008_ICE_SEL,                 NULL,           NULL            }, // 0(OFF) / 1(COLD) / 3(ICE)
    // {   WIFI_FUNC_0009_HOT_TEMP,                EvtWifiTxFunc,  NULL            }, // 0 ~ 3
    ...
    // {   WIFI_FUNC_0031_VOICE_SEL,               NULL,           NULL            },
    // {   WIFI_FUNC_0032_ICELOCK_SEL,             NULL,           NULL            }, // 0 / 1
    // {   WIFI_FUNC_0033_VOICE_VOL_SEL,           NULL,           NULL            },
    ...
    // {   WIFI_FUNC_0037_SLEEP_SEL,               EvtWifiTxFunc,  NULL            }, // 0 / 1
    // {   WIFI_FUNC_0038_MASH_CLEAN,              NULL,           NULL            }, // 0 ~ 5
    {   WIFI_FUNC_0039_HOT_SEL,                 EvtWifiTxFunc,  EvtWifiRxFunc   }, // 0(OFF) / 1(ON)
    // {   WIFI_FUNC_003A_FREEZE_BURST,            NULL,           NULL            },
    // {   WIFI_FUNC_003B_HOT_TEMP_SEL,            NULL,           NULL            },
    // {   WIFI_FUNC_003C_COLD_STRENGTH_SEL,       NULL,           NULL            }, // 0 / 1
    {   WIFI_FUNC_003D_HEIGHT_SEL,              EvtWifiTxFunc,  EvtWifiRxFunc   }, // 1 ~ 4
    ...
    // {   WIFI_FUNC_0047_WATER_QUANTITY_SEL,      NULL,           NULL            },
    ...
    // {   WIFI_FUNC_0050_UV_STERILIZE_STATUS,     NULL,           NULL            },
    // {   WIFI_FUNC_0051_QUANTITY_USE_SEL,        NULL,           NULL            },
    // {   WIFI_FUNC_0052_VOICE_MODE_SEL,          NULL,           NULL            },
    {   WIFI_FUNC_0053_FILTER_RESET1,           EvtWifiTxFunc,  NULL            },
    {   WIFI_FUNC_0054_FILTER_RESET2,           EvtWifiTxFunc,  NULL            },
    {   WIFI_FUNC_0055_FILTER_RESET3,           EvtWifiTxFunc,  NULL            },
    // {   WIFI_FUNC_0056_FILTER_RESET4,           NULL,           NULL            },
    {	WIFI_FUNC_005C_SMART_CHECK_RESULT,	    EvtWifiTxFunc,	EvtWifiRxFunc   },
    // {	WIFI_FUNC_005D_UV_ICE_FAUCET_STATUS,	EvtWifiTxFunc,	EvtWifiRxFunc   },
    ...
    {	WIFI_FUNC_0065_DEFAULT_TEMP_SEL,	    EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_0066_DEFAULT_QUANTITY_SEL,	EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_0067_WATER_QUANTITY_USE_SEL0,	EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_0068_WATER_QUANTITY_USE_SEL1,	EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_0069_WATER_QUANTITY_USE_SEL2,	EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_006A_WATER_QUANTITY_USE_SEL3,	EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_006B_WATER_QUANTITY_USE_SEL4,	EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_006C_WATER_QUANTITY_USE_SEL5,	EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_006D_WATER_QUANTITY_USE_SEL6,	EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_006E_WATER_QUANTITY_USE_SEL7, EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_006F_WATER_QUANTITY_USE_SEL8, EvtWifiTxFunc,	EvtWifiRxFunc   },

    // {	WIFI_FUNC_0070_WATER_QUANTITY_USE_SEL9, EvtWifiTxFunc,	EvtWifiRxFunc   },
    // {	WIFI_FUNC_0071_WATER_QUANTITY_USE_SEL10, EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_0072_WATER_QUANTITY_SORT_SEL,	EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_0073_WATER_TEMP_SORT_SEL,	    EvtWifiTxFunc,	EvtWifiRxFunc   },
    // {	WIFI_FUNC_0074_UNUSE_POWER_SAVING_SEL,	EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_0075_TEMP_UNIT_SEL,	        EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_0076_WATER_QUANTITY_UNIT_SEL,	EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_0077_HOT_TARGET_TEMP_TIME,	EvtWifiTxFunc,	NULL	        },
    {	WIFI_FUNC_0078_COLD_TARGET_TEMP_TIME,	EvtWifiTxFunc,	NULL	        },
    {	WIFI_FUNC_0079_MIXED_WATER_AVE_TEMP,	EvtWifiTxFunc,	NULL	        },
    {	WIFI_FUNC_007A_MIXED_WATER_MIN_TEMP,	EvtWifiTxFunc,	NULL	        },
    {	WIFI_FUNC_007B_MIXED_WATER_MAX_TEMP,	EvtWifiTxFunc,	NULL	        },
    {	WIFI_FUNC_007C_COLDTANK_LOW_WATERLEVEL,	EvtWifiTxFunc,	NULL	        },
    {	WIFI_FUNC_007D_COLDTANK_HIGH_WATERLEVEL,EvtWifiTxFunc,	NULL	        },
    // {	WIFI_FUNC_007E_HIGH_TEMP_STL_SEL,       NULL,	        NULL	        },
    // {	WIFI_FUNC_007F_HIGH_TEMP_STL_STATUS,    NULL,	        NULL	        },

    // {	WIFI_FUNC_0080_HIGH_TEMP_STL_TIME,      NULL,	        NULL	        },
    // {	WIFI_FUNC_0081_HIGH_TEMP_STL_TIME_M,    NULL,	        NULL	        },
    {	WIFI_FUNC_0082_UNUSE_POW_SAVING_STATUS,	EvtWifiTxFunc,	NULL	        },
    {	WIFI_FUNC_0083_POWER_SAVING_STATUS,	    EvtWifiTxFunc,	NULL	        },
    {	WIFI_FUNC_0084_HOT_RESTARTING_TEMP,	    EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_0085_HOT_STOP_TEMP,	        EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_0086_COLD_RESTARTING_TEMP,	EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_0087_COLD_STOP_TEMP,	        EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_0088_COLD_ADDITIONAL_TIME,	EvtWifiTxFunc,	EvtWifiRxFunc   },
    // {	WIFI_FUNC_0089_BOOST_PUMP_STATUS,	    NULL,	        NULL            },
    {	WIFI_FUNC_008A_COLDTANK_UV_STL_STATUS,	EvtWifiTxFunc,	NULL	        },
    {	WIFI_FUNC_008B_HEATER_STATUS,	        EvtWifiTxFunc,	NULL	        },
    {	WIFI_FUNC_008C_COMP_STATUS,	            EvtWifiTxFunc,	NULL	        },
    {	WIFI_FUNC_008D_FILTER_WATER_USAGE,	    EvtWifiTxFunc,	NULL	        },
    {	WIFI_FUNC_008E_FILTER_REMAINING_DAY,	EvtWifiTxFunc,	NULL	        },
    // {	WIFI_FUNC_008F_ICE_FULL_STATUS,	        NULL,	        NULL            },
    ...
    // {	WIFI_FUNC_0093_ICEMAKING_STAUTS,	    NULL,	        NULL            },
    // {	WIFI_FUNC_0094_DUMMY_DEICING_STAUTS,	NULL,	        NULL            },
    // {	WIFI_FUNC_0095_ICEMAKING_COMPLET_TIME,	NULL,	        NULL            },
    // {	WIFI_FUNC_0096_DEICING_COMPLET_TIME,	NULL,	        NULL            },
    // {	WIFI_FUNC_0097_TARY_WATER_COMPLET_TIME,	NULL,	        NULL            },
    // {	WIFI_FUNC_0098_TARY_WATER_QUANTITY,	    NULL,	        NULL            },
    ...
    // {	WIFI_FUNC_009F_ICE_EVA_TEMP,	        NULL,	        NULL            }

    {	WIFI_FUNC_00A0_COLD_TANK_TEMP,	        EvtWifiTxFunc,	NULL            },
    {	WIFI_FUNC_00A1_HOT_TANK_TEMP,	        EvtWifiTxFunc,	NULL            },
    {	WIFI_FUNC_00A2_CHILD_LOCK,	            EvtWifiTxFunc,	EvtWifiRxFunc   }
};
...
#ifdef MODEL_NO_2  // Western Built IN
static const WifiTxFuncList_T WifiFuncList[] =
{   /*  ID                                      Tx Function     Rx Function     */
    // {   WIFI_FUNC_0001_POWER_SEL,               NULL,           NULL            }, // 0(OFF) / 1(ON)
    {   WIFI_FUNC_0002_COLD_SEL,                EvtWifiTxFunc,  EvtWifiRxFunc   }, // 0 / 1
    ...
    // {   WIFI_FUNC_000A_COLD_TEMP,               NULL,           NULL            }, // 0 ~ 3
    {   WIFI_FUNC_000B_WATER_SEL,               EvtWifiTxFunc,  NULL            }, // 1(A) / 2(C) / 3(H)
    // {   WIFI_FUNC_000C_USER_SEL,                NULL,           NULL            }, // 0 ~ 3
    {   WIFI_FUNC_000D_WATER_OUTQUANTITY,       EvtWifiTxFunc,  NULL            }, // 0 ~ 65535 cc
    // {   WIFI_FUNC_000E_TIME_YEAR,               NULL,           NULL            },
    ...
    // {   WIFI_FUNC_0013_STERILIZE_TIME,          NULL,           NULL            },
    // {   WIFI_FUNC_0014_STERILIZE_STATUS,        NULL,           NULL            }, // 0 / 1 / 2(Going)
    {   WIFI_FUNC_0015_TDS_IN,                  EvtWifiTxFunc,  NULL            },
    {   WIFI_FUNC_0016_TDS_OUT,                 EvtWifiTxFunc,  NULL            },
    // {   WIFI_FUNC_0017_WATER_PRESSURE,          NULL,           NULL            },
    {   WIFI_FUNC_0018_TDS_INTEMP,              EvtWifiTxFunc,  NULL            },
    {   WIFI_FUNC_0019_TDS_OUTTEMP,             EvtWifiTxFunc,  NULL            },
    // {   WIFI_FUNC_001A_HOT_INTEMP,              NULL,           NULL            }, // 0 ~ 99 Temp (H)
    // {   WIFI_FUNC_001B_HOT_MEANTEMP,            NULL,           NULL            }, // 0 ~ 99 Temp (H)
    {   WIFI_FUNC_001C_HOT_SELTEMP,             EvtWifiTxFunc,           NULL   }, // 0 ~ 99 Temp (H)
    // {   WIFI_FUNC_001D_WATER_INQUANTITY,        NULL,           NULL            },
    {   WIFI_FUNC_001E_AUTODRAIN_SEL,           EvtWifiTxFunc,  EvtWifiRxFunc   },
    ...
    // {   WIFI_FUNC_0034_LIGHT_SEL,               NULL,           NULL            },
    {   WIFI_FUNC_0035_COVER1_OPEN,             EvtWifiTxFunc,  NULL            }, // 0 / 1
    {   WIFI_FUNC_0036_COVER2_OPEN,             EvtWifiTxFunc,  NULL            },
    // {   WIFI_FUNC_0037_SLEEP_SEL,               NULL,           NULL            }, // 0 / 1  // icon 2.0 rx function ??????_ssg
    // {   WIFI_FUNC_0038_MASH_CLEAN,              NULL,           NULL            }, // 0 ~ 5
    {   WIFI_FUNC_0039_HOT_SEL,                 EvtWifiTxFunc,  EvtWifiRxFunc   },
    // {   WIFI_FUNC_003A_FREEZE_BURST,            NULL,           NULL            },
    // {   WIFI_FUNC_003B_HOT_TEMP_SEL,            NULL,           NULL           },
    // {   WIFI_FUNC_003C_COLD_STRENGTH_SEL,       NULL,           NULL            }, // 0 / 1
    {   WIFI_FUNC_003D_HEIGHT_SEL,              EvtWifiTxFunc,  EvtWifiRxFunc   }, // 1 ~ 4
    ...
    {   WIFI_FUNC_0044_FILTER_STATUS2,          EvtWifiTxFunc,  NULL            },
    {   WIFI_FUNC_0045_FILTER_STATUS3,          EvtWifiTxFunc,  NULL            },
    // {   WIFI_FUNC_0046_FILTER_STATUS4,          NULL,           NULL            },
    // {   WIFI_FUNC_0047_WATER_QUANTITY_SEL,      NULL,           NULL            },
    // {   WIFI_FUNC_0048_HOT_TEMP_SEL,            NULL,           NULL            },
    {   WIFI_FUNC_0049_OUT_BUTTON_LIGHT,        EvtWifiTxFunc,  EvtWifiRxFunc   },
    ...
    {	WIFI_FUNC_007D_COLDTANK_HIGH_WATERLEVEL,EvtWifiTxFunc,	NULL	        },
    // {	WIFI_FUNC_007E_HIGH_TEMP_STL_SEL,       NULL,	        NULL	        },
    {	WIFI_FUNC_007F_HIGH_TEMP_STL_STATUS,    EvtWifiTxFunc,	NULL	        },

    {	WIFI_FUNC_0080_HIGH_TEMP_STL_TIME,      EvtWifiTxFunc,	EvtWifiRxFunc	        },
    // {	WIFI_FUNC_0081_HIGH_TEMP_STL_TIME_M,    NULL,	        NULL	        },
    {	WIFI_FUNC_0082_UNUSE_POW_SAVING_STATUS,	EvtWifiTxFunc,	NULL	        },
    {	WIFI_FUNC_0083_POWER_SAVING_STATUS,	    EvtWifiTxFunc,	NULL	        },
    {	WIFI_FUNC_0084_HOT_RESTARTING_TEMP,	    EvtWifiTxFunc,	EvtWifiRxFunc   },
    ...
    {	WIFI_FUNC_0087_COLD_STOP_TEMP,	        EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_0088_COLD_ADDITIONAL_TIME,	EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_0089_BOOST_PUMP_STATUS,	    EvtWifiTxFunc,	NULL            },
    // {	WIFI_FUNC_008A_COLDTANK_UV_STL_STATUS,	EvtWifiTxFunc,	NULL	        },
    {	WIFI_FUNC_008B_HEATER_STATUS,	        EvtWifiTxFunc,	NULL	        },
    {	WIFI_FUNC_008C_COMP_STATUS,	            EvtWifiTxFunc,	NULL	        },
    {	WIFI_FUNC_008D_FILTER_WATER_USAGE,	    EvtWifiTxFunc,	NULL	        },
    ...
    // {	WIFI_FUNC_0090_ICE_TRAY_POSITION_STATUS,EvtWifiTxFunc,	NULL            },
    // {	WIFI_FUNC_0091_REFRIGERANT_SWC_STATUS,	EvtWifiTxFunc,	NULL            },
    // {	WIFI_FUNC_0092_DEICING_STAUTS,	        NULL,	        NULL            },
    // {	WIFI_FUNC_0093_ICEMAKING_STAUTS,	    EvtWifiTxFunc,	NULL            },
    // {	WIFI_FUNC_0094_DUMMY_DEICING_STAUTS,	EvtWifiTxFunc,	NULL            },
    ...
    // {	WIFI_FUNC_0099_COMP_TARGET_RPS,	        EvtWifiTxFunc,	NULL            },
    // {	WIFI_FUNC_009A_COMP_CURRENT_RPS,	    NULL,	        NULL            },
    // {	WIFI_FUNC_009B_DRAINTANK_LOW_WLEVEL,    EvtWifiTxFunc,	NULL            },
    // {	WIFI_FUNC_009C_DRAINTANK_HIGH_WLEVEL,	EvtWifiTxFunc,	NULL            },
    // {	WIFI_FUNC_009D_DRAINTANK_DRAIN_STAUTS,  EvtWifiTxFunc,	NULL            },
    // {	WIFI_FUNC_009E_COLD_EVA_TEMP,	        NULL,	        NULL            },
    ...
    {	WIFI_FUNC_00A1_HOT_TANK_TEMP,	        EvtWifiTxFunc,	NULL            },
    {	WIFI_FUNC_00A2_CHILD_LOCK,	            EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_00A3_FLOWPATH_EMPTY,	        EvtWifiTxFunc,	EvtWifiRxFunc   },
...
{   /*  ID                                      Tx Function     Rx Function     */
    ...
    {	WIFI_FUNC_006D_WATER_QUANTITY_USE_SEL6,	EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_006E_WATER_QUANTITY_USE_SEL7, EvtWifiTxFunc,	EvtWifiRxFunc   },
    // {	WIFI_FUNC_006F_WATER_QUANTITY_USE_SEL8, EvtWifiTxFunc,	EvtWifiRxFunc   }, // 32oz Remove
    ...
    {	WIFI_FUNC_007D_COLDTANK_HIGH_WATERLEVEL,EvtWifiTxFunc,	NULL	        },
    // {	WIFI_FUNC_007E_HIGH_TEMP_STL_SEL,       NULL,	        NULL	        },
    // {	WIFI_FUNC_007F_DEFAULT_TEMP_SET,    EvtWifiTxFunc,	NULL	        },

    {	WIFI_FUNC_0080_HIGH_TEMP_STL_TIME,      EvtWifiTxFunc,	EvtWifiRxFunc   },
    {	WIFI_FUNC_0081_HIGH_TEMP_STL_TIME_M,    EvtWifiTxFunc,	EvtWifiRxFunc	},
    {	WIFI_FUNC_0082_UNUSE_POW_SAVING_STATUS,	EvtWifiTxFunc,	NULL	        },
    {	WIFI_FUNC_0083_POWER_SAVING_STATUS,	    EvtWifiTxFunc,	NULL	        },
    // {	WIFI_FUNC_0084_HOT_RESTARTING_TEMP,	    EvtWifiTxFunc,	EvtWifiRxFunc   },
    // {	WIFI_FUNC_0085_HOT_STOP_TEMP,	        EvtWifiTxFunc,	EvtWifiRxFunc   },
    ...
    {	WIFI_FUNC_00A9_UNUSED_TIME,	            EvtWifiTxFunc,	    NULL            },
    {	WIFI_FUNC_00AA_SMART_SAVING_SET_TIME,	EvtWifiTxFunc,	    EvtWifiRxFunc   },
    {	WIFI_FUNC_00AB_SAMRT_SAVING_STATE,	    EvtWifiTxFunc,	    NULL            },
    {	WIFI_FUNC_00AC_FILTER1_WATER_USAGE,	    EvtWifiTxFunc,	    NULL            },
    {	WIFI_FUNC_00AD_FILTER1_UASGE_DAY,	    EvtWifiTxFunc,	    NULL            },
    {	WIFI_FUNC_00AE_FILTER2_WATER_USAGE,	    EvtWifiTxFunc,	    NULL            },
    {	WIFI_FUNC_00AF_FILTER2_UASGE_DAY,	    EvtWifiTxFunc,	    NULL            },
    {	WIFI_FUNC_00B0_FILTER3_WATER_USAGE,	    EvtWifiTxFunc,	    NULL            },
    {	WIFI_FUNC_00B1_FILTER3_UASGE_DAY,	    EvtWifiTxFunc,	    NULL            },
    {	WIFI_FUNC_00B2_FILTER_NOTICE1,	        EvtWifiTxFunc,	    NULL            },
    {	WIFI_FUNC_00B3_FILTER_NOTICE2,	        EvtWifiTxFunc,	    NULL            },
    {	WIFI_FUNC_00B4_FILTER_NOTICE3,	        EvtWifiTxFunc,	    NULL            },
    {	WIFI_FUNC_00B5_FILTER_FLUSHING,	        EvtWifiTxFunc,	    NULL            },
    {	WIFI_FUNC_00B6_VOICE_LANGUAGE,	        EvtWifiTxFunc,	    EvtWifiRxFunc   },
    {	WIFI_FUNC_00B7_FILTER_SEQ,	            EvtWifiTxFunc,	    EvtWifiRxFunc   },
    {	WIFI_FUNC_00B8_FILTER1_DDAY,	        EvtWifiTxFunc,	    NULL            },
    {	WIFI_FUNC_00B9_FILTER2_DDAY,	        EvtWifiTxFunc,	    NULL            },
    {	WIFI_FUNC_00BA_FILTER3_DDAY,	        EvtWifiTxFunc,	    NULL            },
    // {	WIFI_FUNC_00BB_FLOWPATH_STL_STATUS,	    EvtWifiTxFunc,	    NULL            },
    // {	WIFI_FUNC_00BC_FAUCE_STL_STATUS,	    EvtWifiTxFunc,	    NULL            },
    {	WIFI_FUNC_00BD_ICETANK_STL_STATUS,	    EvtWifiTxFunc,	    NULL            },
    ...
    {	WIFI_FUNC_00D0_UV_ICE_TANK_STATUS2,	    EvtWifiTxFunc,	    NULL            },
    {	WIFI_FUNC_00D1_ALTITUDE_AUTO,	        EvtWifiTxFunc,	    EvtWifiRxFunc   },

    {	WIFI_FUNC_00FF_CLEANING_STATUS,	        EvtWifiTxFunc,	    NULL            },
    {	WIFI_FUNC_0100_CLEANING_SW_STATUS,	    EvtWifiTxFunc,	    NULL            },
    {	WIFI_FUNC_0101_STERILIZE_REMAINING_DAY,	EvtWifiTxFunc,	    NULL            },
};
