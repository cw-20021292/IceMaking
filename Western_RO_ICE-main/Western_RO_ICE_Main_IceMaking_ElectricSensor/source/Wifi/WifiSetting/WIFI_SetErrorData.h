...
typedef enum
{
    ...
    WIFI_ERROR_003F_NATURAL2_TEMP,
    WIFI_ERROR_0040_TRAY_IN_TEMP,
    WIFI_ERROR_0041_FLOW_STOP,
    WIFI_ERROR_0042_FLOW_QUANTITY,
    WIFI_ERROR_0043_FLOW_CLOGGING,
    WIFI_ERROR_0044_UV_COLD_TANK2,
    WIFI_ERROR_0045_UV_ICE_TANK3,
    WIFI_ERROR_0046_DARIN_CLOSE,
    WIFI_ERROR_0047_TDS_IN_WATER, // E98
    
    WIFI_ERROR_0048_COLD_TEMP_OC,
    WIFI_ERROR_0049_BLDC_STATUS1,
    WIFI_ERROR_004A_BLDC_STATUS2,
    WIFI_ERROR_004B_BLDC_STATUS3,
    WIFI_ERROR_004C_BLDC_STATUS4,
    WIFI_ERROR_004D_BLDC_STATUS5,
    WIFI_ERROR_004E_BLDC_STATUS6,
    WIFI_ERROR_004F_HOT_HIGH_LEVEL,
