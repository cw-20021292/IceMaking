...
{   /*  ID                                  Tx Function     Rx Function */
    ...
    {   WIFI_SENSOR_0002_HOT_TEMP,          EvtWifiSensor,  NULL    },
    // {   WIFI_SENSOR_0003_WATER_TEMP,        NULL,           NULL    },
    // {   WIFI_SENSOR_0004_OUT_TEMP,          NULL,           NULL    },
    ...
    {   WIFI_SENSOR_0014_HEATER_DATA,       EvtWifiSensor,  NULL    }
};
#endif
...
{   /*  ID                                  Tx Function     Rx Function */
    ...
    {   WIFI_SENSOR_0004_OUT_TEMP,          EvtWifiSensor,  NULL    },
    // {   WIFI_SENSOR_0005_LUX_DATA,          NULL,           NULL    },
    {   WIFI_SENSOR_0006_FILTER1_DATA,      EvtWifiSensor,  NULL    },
    {   WIFI_SENSOR_0007_FILTER2_DATA,      EvtWifiSensor,  NULL    },
    {   WIFI_SENSOR_0008_FILTER3_DATA,      EvtWifiSensor,  NULL    },
    // {   WIFI_SENSOR_0009_FILTER4_DATA,      NULL,           NULL    },
    // {   WIFI_SENSOR_000A_VOLTAGE_DATA,      NULL,           NULL    },
    // {   WIFI_SENSOR_000B_CURRENT_DATA,      NULL,           NULL    },
    // {   WIFI_SENSOR_000C_FACTOR_DATA,       NULL,           NULL    },
    ...
    // {   WIFI_SENSOR_0013_COLD_DOWN_TEMP,    NULL,           NULL    },
    {   WIFI_SENSOR_0014_HEATER_DATA,       EvtWifiSensor,  NULL    },
    {   WIFI_SENSOR_0015_OUT2_TEMP,         EvtWifiSensor,  NULL    },
    {   WIFI_SENSOR_0016_BAR_PRESSURE,      EvtWifiSensor,  NULL    }
};
#endif
