...
{   /*  ID                  Display             Error           ApWiFi      ApBLE       ApStep                  Server      Sound                       Function    */
    {   AT_RX_DEVICE_READY, WIFI_DISP_TRY,      WIFI_NULL,      WIFI_NULL,  WIFI_NULL,  WIFI_AP_STEP_CLEAR,     CLEAR,      WIFI_NULL,                  RxReady     },  // Module On
...
{    
    ...
    if ( GetWifiApStatus( STATUS_AP_BLE_ALWAYS ) != CLEAR )
    {
